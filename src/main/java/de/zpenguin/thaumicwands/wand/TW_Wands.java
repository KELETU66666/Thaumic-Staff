...
public class TW_Wands {
	...
	public static final IStaffCore coreGreatwood = new StaffCore("greatwood", 150, new ItemStack(TW_Items.itemStaffCore, 1, 0));
	public static final IStaffCore coreReed = new StaffCore("reed", 300, new ItemStack(TW_Items.itemStaffCore, 1, 1), new UpdateAir());
	public static final IStaffCore coreBlaze = new StaffCore("blaze", 300, new ItemStack(TW_Items.itemStaffCore, 1, 2), new UpdateFire());
	public static final IStaffCore coreIce = new StaffCore("ice", 300, new ItemStack(TW_Items.itemStaffCore, 1, 3), new UpdateWater());
	public static final IStaffCore coreObsidian = new StaffCore("obsidian", 300, new ItemStack(TW_Items.itemStaffCore, 1, 4), new UpdateEarth());
	public static final IStaffCore coreQuartz = new StaffCore("quartz", 300, new ItemStack(TW_Items.itemStaffCore, 1, 5));
	public static final IStaffCore coreBone = new StaffCore("bone", 300, new ItemStack(TW_Items.itemStaffCore, 1, 6));
	public static final IStaffCore coreSilverwood = new StaffCore("silverwood", 600, new ItemStack(TW_Items.itemStaffCore, 1, 7));

...
public class ItemStaff extends ItemBase implements IStaff {
	...
	public void getSubItems(CreativeTabs tab, NonNullList<ItemStack> items) {
		if(tab == this.getCreativeTab()) {
			for(ItemStack wand : new ItemStack[]{WandHelper.getStaffWithParts("wood", "iron"), WandHelper.getStaffWithParts("greatwood", "brass"), WandHelper.getStaffWithParts("silverwood", "thaumium")}) {
				items.add(wand.copy());
